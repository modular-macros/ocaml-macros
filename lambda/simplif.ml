...
let rec eliminate_ref id = function
  ...
  | Lsplice _ -> assert false (* MACO-REV OUt of curioisity, I am not being conservative here, 
                                 this should NEVER happen, unless translation begins inter-
                                 leaving optimisations *)
